  ...
  $.fn.extend({
    ...
    navigation: function (options) {
      ...
      if (!self.hasClass(opts.initClass)) {
                  ...
                  if (close) {
                    if ($(this).parent().find("ul") != visible[visibleIndex]) {
                      $(visible[visibleIndex]).slideUp(opts.speed + 300, opts.animate, function () {
                        $(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", false).find("b:first").html(opts.closedSign);
            ...
            if ($(this).parent().find("ul:first").is(":visible") && !$(this).parent().find("ul:first").hasClass("active")) {
              $(this)
                ...
                .slideUp(opts.speed + 100, opts.animate, function () {
                  $(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", false).find("b:first").delay(opts.speed).html(opts.closedSign);
              ...
              $(this)
                ...
                .slideDown(opts.speed, opts.animate, function () {
                  $(this).parent("li").addClass("open").find("a:first").attr("aria-expanded", true).find("b:first").delay(opts.speed).html(opts.openedSign);
        ...
        if (myapp_config.debugState) console.log(self.get(0) + " this menu already exists");
      }
    },
...
var initApp = (function (app) {
    ...
    $(input)
      .change(function () {
        ...
        if (filter.length > 1) {
          ...
          $(list)
            .find($("[data-filter-tags]:not([data-filter-tags*='" + filter + "'])"))
            .parentsUntil(list)
  ...
  app.loadScript = function (scriptName, callback) {
    ...
    } else if (myapp_config.debugState) console.log("This script was already loaded: " + scriptName);
  ...
  app.saveSettings = function () {
    ...
    if (typeof saveSettings !== "undefined" && $.isFunction(saveSettings) && myapp_config.storeLocally) {
      ...
      if (myapp_config.debugState) console.log("Theme settings: " + "\n" + localStorage.getItem("themeSettings"));
    } else {
  ...
  app.playSound = function (path, sound) {
    ...
    if (navigator.userAgent.match("Firefox/")) audioElement.setAttribute("src", path + "/" + sound + ".ogg");
  ...
  app.checkNavigationOrientation = function () {
    ...
    switch (true) {
      case myapp_config.root_.hasClass("nav-function-fixed") &&
        !myapp_config.root_.is(".nav-function-top, .nav-function-minify, .mod-main-boxed") &&
        myapp_config.thisDevice === "desktop":
        ...
        if (typeof $.fn.slimScroll !== "undefined") {
          ...
          if (document.getElementById(myapp_config.navHorizontalWrapperId)) {
            ...
            if (myapp_config.debugState) console.log("----top controls destroyed");
          }
    ...
    switch (true) {
      ...
      case $.fn.menuSlider && myapp_config.root_.hasClass("nav-function-top") && $("#js-nav-menu-wrapper").length == false && !myapp_config.root_.hasClass("mobile-view-activated"):
        ...
        if (myapp_config.debugState) console.log("----top controls created -- case 1");
      ...
      case myapp_config.root_.hasClass("nav-function-top") && $("#js-nav-menu-wrapper").length == true && myapp_config.root_.hasClass("mobile-view-activated"):
        ...
        /* build horizontal nav */
        if (myapp_config.debugState) console.log("----top controls destroyed -- case 2");
      ...
      case !myapp_config.root_.hasClass("nav-function-top") && $("#js-nav-menu-wrapper").length == true:
        ...
        /* build horizontal nav */
        if (myapp_config.debugState) console.log("----top controls destroyed -- case 3");
  ...
  app.buildNavigation = function (id) {
    ...
    if ($.fn.navigation) {
      ...
      if (myapp_config.debugState) console.log("WARN: navigation plugin missing");
    }
  };
  ...
  app.mobileCheckActivation = function () {
    ...
    if (myapp_config.debugState) console.log("mobileCheckActivation on " + $(window).width() + " | activated: " + myapp_config.mobileMenuTrigger);
  ...
  app.domReadyMisc = function () {
    ...
    if (myapp_config.appDateHook.length) {
      var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        ...
        now = new Date(),
        formatted = day[now.getDay()] + ", " + months[now.getMonth()] + " " + now.getDate() + ", " + now.getFullYear();
    ...
    if (typeof $.fn.slimScroll !== "undefined" && myapp_config.thisDevice === "desktop") {
      ...
      if (myapp_config.debugState) console.log("%c✔ SlimScroll plugin active", "color: #148f32");
    } else {
    ...
    if (window.Waves && myapp_config.rippleEffect) {
      ...
      if (myapp_config.debugState) console.log("%c✔ Waves plugin active", "color: #148f32");
    } else {
      if (myapp_config.debugState) console.log("%c✘ Waves plugin inactive! ", "color: #fd3995");
    }
    ...
    myapp_config.root_.on("click touchend", "[data-action]", function (e) {
      ...
      switch (true) {
        ...
        case actiontype === "panel-collapse":
          ...
          selectedPanel
            ...
            .on("show.bs.collapse", function () {
              ...
              if (myapp_config.debugState) console.log("panel id:" + selectedPanel.attr("id") + " | action: uncollapsed");
            })
            .on("hidden.bs.collapse", function () {
              selectedPanel.addClass("panel-collapsed");

              if (myapp_config.debugState) console.log("panel id:" + selectedPanel.attr("id") + " | action: collapsed");
            });
        ...
        case actiontype === "panel-fullscreen":
          ...
          if (myapp_config.debugState) console.log("panel id:" + selectedPanel.attr("id") + " | action: fullscreen");
        ...
        case actiontype === "panel-close":
          ...
          var killPanel = function () {
            selectedPanel.fadeOut(500, function () {
              ...
              if (myapp_config.debugState) console.log("panel id:" + selectedPanel.attr("id") + " | action: removed");
            });
          };
          ...
          if (typeof bootbox != "undefined") {
            ...
            bootbox.confirm({
              title:
                ...
                selectedPanel.children(".panel-hdr").children("h2").text().trim() +
                "'&nbsp;</span>?",
        ...
        case actiontype === "app-fullscreen":
          ...
          if (!document.fullscreenElement && !document.mozFullScreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) {
            ...
            if (myapp_config.debugState) console.log("app fullscreen toggle active");
          } else {
            ...
            if (myapp_config.debugState) console.log("%capp fullscreen toggle inactive! ", "color: #ed1c24");
          }
      ...
      if (myapp_config.debugState) console.log("data-action clicked: " + actiontype);
     ...
     **/
    if (myapp_config.debugState) console.log("%c✔ Finished app.init() v" + myapp_config.VERSION + "\n" + "---------------------------", "color: #148f32");
  };
